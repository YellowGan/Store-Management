        ...
        <div class="main">
            ...
            <div class="content">
                ...
                <div class="col2">
                    ...
                    <input type="button" name="submit" value="Fattura acquisto" onclick="location.href='modify/modify_bill_buy.php'">
                    <input type="button" name="submit" value="Vedi acquisto" onclick="location.href='look/look_buy.php'">
                    </form>
                    <form id="cerca" method="POST" action="search/search_buy.php">
