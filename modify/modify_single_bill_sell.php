	...
	<BODY>
		...
		<div class="main">
			...
			<div class="content">
				...
				<div class="col2">
					<br>
					<form method="POST" action="modify_single_bill_sell_db.php">
        			<center><fieldset>
        			...
        			<input type="text" disabled="disabled" maxlength="15" name="id_ordine" value=<?php echo "'".htmlspecialchars($row['id_v'])."'"; ?>>
        			<input type="hidden" name="id_ordine" value=<?php echo "'".htmlspecialchars($row['id_v'])."'"; ?>>
        			<br><br>
        			...
        			<input type="text" maxlength="15" name="fattura" placeholder="fattura (si/no)" value=<?php echo "'".htmlspecialchars($row['fattura_v'])."'"; ?> name="Fattura">
        			<br>
        			<br>
