		...
		<div class="main">
			...
			<div class="content">
				...
				<div class="col2">
    				...
    				<br><br>
    				<form action="#">
        			<input type="button" name="submit" value="Ok" onclick="location.href='modify_bill_buy.php'">
    				</form>
    				<?php
    				die;
					}
    				...
    				$query="UPDATE ordine_acquisto SET data_fattura_a = '".$data_fattura."' WHERE id_a = '".$id_ordine."'";
    				mysql_query($query); 
    				$query="UPDATE ordine_acquisto SET fattura_a = '".$fattura."' WHERE id_a = '".$id_ordine."'";
    				mysql_query($query);
					}
					?>
					<br>
