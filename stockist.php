        ...
        <div class="main">
            ...
            <div class="content">
                ...
                <div class="col2">
                    ...
                    <input type="button" name="submit" value="Modifica fornitore" onclick="location.href='modify/modify_stockist.php'">
                    </form>
                    <form id="cerca" method="post" action="search/search_stockist.php">
