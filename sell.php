        ...
        <div class="main">
            ...
            <div class="content">
                ...
                <div class="col2">
                    ...
                    <input type="button" name="submit" value="Fattura vendita" onclick="location.href='modify/modify_bill_sell.php'">
                    <input type="button" name="submit" value="Vedi vendita" onclick="location.href='look/look_sell.php'">
                    </form>
                    <form id="cerca" method="POST" action="search/search_sell.php">
