        ...
        <div class="main">
            ...
            <div class="content">
                ...
                <div class="col2">
                    ...
                    <input type="button" name="submit" value="Modifica cliente" onclick="location.href='modify_search_client.php?nomeCli=<?php echo $nome; ?>'">
                    </form>
                    <form id="cerca" method="post" action="search_client.php">
                    ...
                    <?php
                    $query="SELECT * FROM cliente WHERE nome_c LIKE '%$nome%' OR cognome_c LIKE '%$nome%'";
