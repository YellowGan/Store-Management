        ...
        <div class="main">
            ...
            <div class="content">
                ...
                <div class="col2">
                    ...
                    <input type="button" name="submit" value="Modifica prodotto" onclick="location.href='modify_search_store_description.php?DescrizionePro=<?php echo $nome; ?>'">
                    </form>
                    ...
                    <?php
                    $descrizione=$_POST['search'];
                    $query="SELECT * FROM magazzino WHERE descrizione LIKE '%$descrizione%'";
