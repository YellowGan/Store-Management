    ...
    <BODY>
        ...
        <div class="main">
            ...
            <div class="content">
                ...
                <div class="col2">
                    <div class="pulsanti">
                    <form id="cerca" method="POST" action="search_bill.php">
                    ...
                    <input type="text" name="dataOrd" placeholder="Inserire data" id="datepicker"/>
                    <input type="submit" name="submit" value="Cerca fatture">
                    </form>
                    </div>
                    ...
                    <?php
                    $query="SELECT * FROM ordine_acquisto WHERE data_fattura_a >= '".$dataOrd."'";
                    ...
                    <?php
                    $query="SELECT * FROM ordine_vendita WHERE data_fattura_v >= '".$dataOrd."'";
                    $risultati=mysql_query($query);
                    $num=mysql_num_rows($risultati);
                    $i=0;
                    while ($i < $num)
