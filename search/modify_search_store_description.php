        ...
        <div class="main">
            ...
            <div class="content">
                ...
                <div class="col2">
                    ...
                    <?php
                    if(isset($_GET['DescrizionePro']))
                    {
                    $nome = $_GET['DescrizionePro'];
                    $query="SELECT * FROM magazzino WHERE descrizione LIKE '%$nome%'";
                    ...
                    while ($i < $num)
                    {
                        ...
                        echo "<td bgcolor='#ffffff' onclick=\"location.href='../modify/modify_single_product.php?id_p=".$idproduct[$i]."'\">".$idproduct[$i]."</td>";
